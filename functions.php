...
function dyad_scripts() {
	...
	wp_enqueue_style( 'dyad-genericons', get_template_directory_uri() . '/genericons/genericons.css', array(), '3.2' );

	wp_enqueue_style( 'dyad-fonts', dyad_fonts_url(), array(), null );

	wp_enqueue_script( 'dyad-imagesloaded', get_template_directory_uri() . '/js/imagesloaded.pk.js', array( 'jquery' ), '20151006', true );
	...
	if ( ( is_front_page() || is_home() ) && dyad_has_banner_posts( 2 ) ) {
		wp_enqueue_script( 'dyad-slick', get_template_directory_uri() . '/js/slick.js', array(), '20140523', true );
	}
